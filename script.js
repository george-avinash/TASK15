...
function updatePagination() {
    ...
    pageInfo.textContent = `Page ${currentPage} of ${Math.ceil(jsonData.length / itemsPerPage)}`;
    prevPageBtn.disabled = currentPage === 1;
    nextPageBtn.disabled = currentPage === Math.ceil(jsonData.length / itemsPerPage);
}
